...
class Player extends Entity{
  ...
  /**
   * skill
   * This method runs applies the abilities to the game depending on which ability
   * @param nothing because it gets values from other methods and changes them
   * @return nothing because it changes other values
   */
  public void skill() {    //ANDREW's code to use skills
    //abilities differ depending on the ability chosen
    if (hat.getHat()==1){ 
      //gives a speed buff by increasing speed
      this.setSpeed(hat.speedHat(this.getSpeed()));
    }else if(hat.getHat()==2){
  ...
  /**
   * getDirectionX
   * This method gets the X direction of movement
   * @param nothing because it is getting a value
  ...
  /**
   * getDirectionY
   * This method gets the Y direction of movement
   * @param nothing because it is getting a value
   * @return the direction of the movement
   * */
